...
/* Estos 3 botones todavía NO tienen ninguna función propia.
   Cada compañero se encarga de programar la suya cuando
   desarrolle su módulo:

   const btnIncentivos      = document.getElementById('btn-incentivos');
   const btnCapacitaciones  = document.getElementById('btn-capacitaciones');
   const btnSalud           = document.getElementById('btn-salud');

   btnIncentivos.addEventListener('click', () => {
       // aquí iría el código de incentivos
   });
*/
